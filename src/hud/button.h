...
DEFINE_ENUM(HudIcon, stance_stand, stance_crouch, stance_prone, down_arrow, up_arrow, left_arrow,
			right_arrow, close);

DEFINE_ENUM(HudButtonStyle, normal, small);

DEFINE_ENUM(HudLabelStyle, left, center, right, disabled);
