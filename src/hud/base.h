...
inline const FRect align(const FRect &rect, const FRect &rel1, Alignment mode1, const FRect &rel2,
						 Alignment mode2, float spacing) {
...
DEFINE_ENUM(HudStyleId, green_white, red_green, console);
