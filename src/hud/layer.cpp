...
float HudLayer::alpha() const { return 1.0f; }

float HudLayer::backAlpha() const { return alpha() * 0.4f; }

Color HudLayer::backColor() const { return (Color)mulAlpha(m_style.layer_color, backAlpha()); }
...
void HudLayer::setWorld(game::PWorld world) { m_world = world; }
