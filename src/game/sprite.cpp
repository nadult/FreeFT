...
PTexture Sprite::MultiImage::toTexture(const MultiPalette &palette, FRect &tex_rect,
...
PTexture Sprite::getFrame(int seq_id, int frame_id, int dir_id, FRect &tex_rect,
						  bool put_in_atlas) const {
	DASSERT(!isPartial());
