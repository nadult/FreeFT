...
DEFINE_ENUM(ContainerSoundType, opening, closing)

DEFINE_ENUM(ContainerState, closed, opened, opening, closing);
...
class Container : public EntityImpl<Container, ContainerProto, EntityId::container> {
  public:
	...
	FlagsType flags() const override {
		return Flags::container | Flags::static_entity | Flags::occluding | Flags::colliding;
	}
